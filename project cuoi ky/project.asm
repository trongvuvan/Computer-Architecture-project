.data 
  welc:         .asciiz "\n__________Welcome to My Calculator _____________!\n" 
  import:        .asciiz "\n Enter the firsth number with a 4-digit number ,\n Ex: Enter 0021 to import 21 . "
  import1:       .asciiz "\n Enter the second number with a 4-digit number, \n Ex: Enter 0001 to import 1 . "
  operator:     .asciiz "\n Enter the operator \n a = +\n b = - \n c = x \n d = / \n "
  co:           .asciiz "\n detected \n"
  result:       .asciiz "\n Result is :  "
  downline:    .asciiz "\n"
  err1:         .asciiz "\n error. enter the operator again \n"
  sb_mul:      .asciiz "\n xxxxxxxxxxxx you choosed multiplication xxxxxxxxxxx. \n"
  sb_div:      .asciiz "\n //////////// you choosed division////////////////.   \n"
  sb_add :     .asciiz "\n ++++++++++++ you choosed summation ++++++++++++++.   \n"
  sb_sub:       .asciiz "\n ----------- you choose Subtraction -------------.  \n"
  sb_table:   .asciiz "\n enter f to show result"
  rep:          .asciiz "\n Enter 0 to exit program or press any key to continue \n "  
  goodbye:      .asciiz "\n Program ended \n"
  erram:        .asciiz "\n result is a negative number , cannot show \n."
...
start:
  ...
  sb $t3,0($t1)
    ...
    #----------------------------------------------------------------------
Loop: 
      beq $s4,4,nhapso2 # wait for interupt
      nop
      beq $s4,4,nhapso2 # wait for interupt
      nop
      beq $s4,4,nhapso2 # wait for interupt
...
nhaptoantu2:
 ...
 Loop3: # Cho nhap vao dau = de hien thi ket qua  
    ...
    case_add:  bne $s2,1,case_sub  # neu la phep cong
